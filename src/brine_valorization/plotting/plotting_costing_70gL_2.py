...
CSV_PATH = "updated_costing_vs_recovery_70gL_2026-08-04_1610.csv"  # <-- put your CSV filename here
...
def plot_stacked_lcow_vs_recovery(df: pd.DataFrame, recovery_col="NaCl Recovery"):
    ...
    ax.set_title(
        "Levelized Cost of Water Breakdown (CapEx, OpEx) vs. NaCl Recovery (70 g/L feed)",
        fontsize=14,
        fontweight="bold",
        pad=15,
    )
...
if __name__ == "__main__":
    ...
    out_path = f"capex_opex_vs_recovery_70gL_{timestamp}.png"
